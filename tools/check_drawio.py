...
PATH = r"d:\Repositorios\VASS-BHD\Diagramas-HU-BHDIB\Diagramas-HU-BHDIB\batik-1.19\hu990929\HU990929-EdicionBeneficiarios.drawio.xml"
...
# check for mxCell children under an mxCell (nested mxCell), which is allowed but labels usually are separate; print counts
nested = []
